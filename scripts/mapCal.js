 var map;
    ...
    require([
      ...
      input.placeholder = "lat, long  e.g. 18.284406, -78.342255";
      ...
      function goToLatLon(text){
        ...
        if (!p){ showError("Please enter like: 18.284406, -78.342255"); return; }
